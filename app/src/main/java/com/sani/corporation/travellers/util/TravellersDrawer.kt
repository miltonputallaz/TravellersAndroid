...
package com.sani.corporation.travellers.util
...
import com.sani.corporation.travellers.main.TravellersDestinations
import com.sani.corporation.travellers.main.TravellersNavigationActions
...
fun AppModalDrawer(
    ...
    currentRoute: String,
    navigationActions: TravellersNavigationActions,
    ...
    Surface(color = MaterialTheme.colorScheme.background) {
        Column(modifier = modifier.fillMaxSize()) {
            ...
            DrawerButton(
                ...
                isSelected = currentRoute == TravellersDestinations.TRAVELS_ROUTE,
                action = {
                    navigateToTasks()
                    closeDrawer()
                }
            ...
            DrawerButton(
                ...
                isSelected = currentRoute == TravellersDestinations.STATISTICS_ROUTE,
                action = {
...
fun PreviewAppDrawer() {
    TravellersTheme {
        Surface {
            AppDrawer(
                currentRoute = TravellersDestinations.TRAVELS_ROUTE,
                navigateToTasks = {},
                navigateToStatistics = {},
                closeDrawer = {}
            )
