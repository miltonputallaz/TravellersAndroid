...
package com.sani.corporation.travellers.taskdetail

import androidx.lifecycle.SavedStateHandle
import com.sani.corporation.travellers.MainCoroutineRule
import com.sani.corporation.travellers.R
import com.sani.corporation.travellers.main.TravellersDestinationsArgs
import com.sani.corporation.travellers.data.FakeTaskRepository
...
class TaskDetailViewModelTest {
    ...
    fun setupViewModel() {
        ...
        taskDetailViewModel = TaskDetailViewModel(
            tasksRepository,
            SavedStateHandle(mapOf(TravellersDestinationsArgs.TASK_ID_ARG to "0"))
        )
    }
    ...
    fun taskDetailViewModel_taskNotFound() = runTest {
        ...
        taskDetailViewModel = TaskDetailViewModel(
            tasksRepository,
            SavedStateHandle(mapOf(TravellersDestinationsArgs.TASK_ID_ARG to "nonexistent_id"))
        )
